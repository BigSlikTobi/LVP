...
const keyPath = process.env.SSL_KEY_PATH || '/path/to/ssl-key.pem';
const certPath = process.env.SSL_CERT_PATH || '/path/to/ssl-cert.pem';

if (!fs.existsSync(keyPath) || !fs.existsSync(certPath)) {
  console.warn('SSL files not found, using HTTP instead.');
  // Handle fallback logic (e.g., create http server)
